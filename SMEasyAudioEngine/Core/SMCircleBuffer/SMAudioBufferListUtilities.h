 ...
 */
#define SMAudioBufferListCreateOnStack(name) \
    SMAudioBufferListCreateOnStackWithFormat(name, SMAudioDescription)
 ...
 */
#define SMAudioBufferListCreateOnStackWithFormat(name, audioFormat) \
 ...
 */
#define SMAudioBufferListCopyOnStack(name, sourceBufferList, offsetFrames) \
    SMAudioBufferListCopyOnStackWithByteOffset(name, sourceBufferList, offsetFrames * SMAudioDescription.mBytesPerFrame)
 ...
 */
#define SMAudioBufferListCopyOnStackWithByteOffset(name, sourceBufferList, offsetBytes) \
 ...
 */
#define SMAudioBufferListCopyOnStackWithChannelSubset(name, sourceBufferList, channelSet) \
 ...
 *  the contents, use SMAudioBufferListCopy or SMAudioBufferListCopyContents
 *
 ...
 */
static inline size_t SMAudioBufferListGetStructSize(const AudioBufferList *bufferList) {
