...
- (instancetype)initWithRenderer:(AERenderer *)renderer {
    ...
    // ioUnit如何输出数据呢?
    // 自定义自己的: renderBlock
    //             然后将请求转发给Render, 开始了Amazing Audio Engine2的处理流程
    ...
    // AEIOAudioUnitDidUpdateStreamFormatNotification 通过iOUnit的变化来更新Render
